    ...
    <section class="con">
      ...
      <div class="mainCon">
        ...
        <div class="previewWrap">
          ...
          />
          <!-- 小图列表 -->
          <!-- <ImageList @currentChange="handCurrentChange" /> -->
        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              <div class="controls">
                <input autocomplete="off" class="itxt" v-model="skuNum" oninput = "value=value.replace(/[^\d]/g,'')" />
  ...
  methods: {
    ...
    callback(errorMsg) {
      if (errorMsg) {
        ...
        const skuNum = this.skuNum;
        // 跳转前把当前商品的skuinfo的json文本数据保存到sessionStorage
