      ...
      <div class="cart-body">
        <ul class="cart-list" v-for="item in cartList" :key="item.id">
          ...
          <li class="cart-list-con5">
            <a href="javascript:" class="mins" @click="changeItemCount(item,-1)">-</a>
            <input
              autocomplete="off"
              type="text"
              :value="item.skuNum"
            ...
            />
            <a href="javascript:" class="plus" @click="changeItemCount(item,+1)">+</a>
          </li>
          <li class="cart-list-con6">
            <span class="sum">{{item.cartPrice*item.skuNum}}</span>
          </li>
          <li class="cart-list-con7">
            <a href="#none" class="sindelet" @click="deleteCheckItem(item)">删除</a>
            <br />
            <a href="#none">移到收藏</a>
          </li>
        </ul>
